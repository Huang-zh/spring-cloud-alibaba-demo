...
![1574232827494](assets/1574232827494.png)
...
![1574236056581](assets/1574236056581.png)
...
![1564219591895](assets/1564219591895.png)
...
![1575771528248](assets/1575771528248.png)
...
![1575776822852](assets/1575776822852.png)
...
![1576767485424](assets/1576767485424.png)
...
![1577410670679](assets/1577410670679.png)
...
![1576829556465](assets/1576829556465.png)
...
- 异常比例：当资源的每秒异常总数占通过量的比值超过阈值之后，资源进入降级状态，即在接下的时间窗口（以 s 为单位）之内，对这个方法的调用都会自动地返回。异常比率的阈值范围是 [0.0, 1.0]。
  ...
  ![1576890877721](assets/1576890877721.png)
...
![1576893729079](assets/1576893729079.png)
...
![1576894317265](assets/1576894317265.png)
...
![1567517267302](assets/1567517267302.png)
...
![1567520406966](assets/1567520406966.png)
...
![1568016201418](assets/1568016201418.png)
...
![1568008591979](assets/1568008591979.png)
...
![1577064116637](assets/1577064116637.png)
...
![1567573844494](assets/1567573844494.png)
...
![1575797420724](assets/1575797420724.png)
...
![1567601333801](assets/1567601333801.png)
...
![1575023708606](assets/1575023708606.png)
...
![1577068117043](assets/1577068117043.png)

第5步：点击其中一条记录，可观察一次访问的详细线路。

![1577068091659](assets/1577068091659.png)
...
![1575028777657](assets/1575028777657.png)
...
![1575039831840](assets/1575039831840.png)
...
![1575041647868](assets/1575041647868.png)
...
![1577621565925](assets/1577621565925.png)
...
![1575042357068](assets/1575042357068.png)
...
![1576034886312](assets/1576034886312.png)
...
![1575257487003](assets/1575257487003.png)
...
![1575897256312](assets/1575897256312.png)
...
![1576041409954](assets/1576041409954.png)
...
![1577775859432](assets/1577775859432.png)

## 短信服务使用

接下来,我们使用**短信验证码**功能来演示短信服务的使用。流程如下:

![1575032299952](assets/1575032299953.png)
...
![1575032299952](assets/1575032299952.png)

#### 申请认证秘钥

![1575032547863](assets/1575032547863.png)

#### 申请短信签名

![1575032447205](assets/1575032447205.png)

#### 申请短信模板

![1575032472181](assets/1575032472181.png)
...
![1574995834565](assets/1574995834565.png)
...
![1575789052170](assets/1575789052170.png)
...
![1575793046861](assets/1575793046861.png)

2   新建一个名为service-product-test.yaml配置存放测试环境的配置

![1575793710654](assets/1575793710654.png)

3 新建一个名为consumer-dev.yaml配置存放开发环境的配置

![1575793563051](assets/1575793563051.png)
...
![1575794168594](assets/1575794168594.png)
...
![1575775326951](assets/1575775326951.png)
...
- 单体系统访问多个数据库
  ...
  ![1575293293584](assets/1575293293584.png)

- 多个微服务访问同一个数据库

  多个服务需要调用一个数据库实例完成数据的增删改操作

  ![1575292977906](assets/1575292977906.png)

- 多个微服务访问多个数据库

  多个服务需要调用一个数据库实例完成数据的增删改操作

  ![1575293162533](assets/1575293162533.png)
...
![1577889106706](assets/1577889106706.png)
...
![1575516443930](assets/1575516443930.png)
...
![1575518767837](assets/1575518767837.png)
...
![1577889155043](assets/1577889155043.png)

![1577889211636](assets/1577889211636.png)
...
![1575726860916](assets/1575726860916.png)
...
![img](assets/10168631-af89ea88de5a7314.webp)
...
![1577941770068](assets/1577941770068.png)
...
![](assets/seata-1577949562680.jpg)
...
![1578057475145](assets/1578057475145.png)
